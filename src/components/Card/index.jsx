...
const Card = ({ data }) => {
  ...
  return (
    <div className="group w-[32%] h-[360px] rounded-[16px] border border-solid border-transparent transition duration-500 hover:scale-110  delay-100 hover:z-10 mt-4">
      ...
      <div className="content-card group-hover:bg-card-bg rounded-b-[16px] transition-colors duration-300 delay-100">
        <div className="flex flex-wrap pt-4 transition duration-500 delay-100">
          ...
          <div className="w-[80%] mb-3">
            ...
            <p className="text-[#ffffff99] text-[16px] uppercase font-semibold my-2 hover:cursor-pointer hover:text-white">
              {data.author.name}
            </p>
